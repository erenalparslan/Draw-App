package com.erenalparslan.drawapp
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    ...
                    if (perMissionName == Manifest.permission.READ_EXTERNAL_STORAGE) Toast.makeText(
        ...
        withContext(Dispatchers.IO) {
            if (mBitmap != null) {
                ...
                try {
                    ...
                    val f = File(
                        externalCacheDir?.absoluteFile.toString() + File.separator + "KidDrawingApp_" + System.currentTimeMillis() / 1000 + ".jpg"
                    )
